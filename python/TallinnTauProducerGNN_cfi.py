...
tallinnTaus = cms.EDProducer("TallinnTauProducer",
    ...
    tfGraph = cms.PSet(
        ...
        pfCandInputs = cms.vstring("logpt", "logEnergy", "dEta_pfCandSum", "dPhi_pfCandSum", "particleId", "charge", "dR_pfCandSum", "dz", "logabsdz", "logrelpt_pfCandSum", "pfCandSum_pt", "pfCandSum_eta", "pfCandSum_phi", "logReldR_pfCandSum"),
